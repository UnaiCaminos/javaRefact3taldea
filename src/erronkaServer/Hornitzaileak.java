	...
	public Hornitzaileak() {
		...
		btnLike.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String sql = "SELECT * FROM hornitzaileak WHERE EmpresarenIzena like'"+like+"%'";
				Statement st;
				ResultSet rs;
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
				    ...
				    Id2=txtId2.getText();
				    String query ="DELETE FROM erronka2.hornitzaileak WHERE EmpresarenIzena= '"+izena+"'&& id= '"+Id2+"'";
				    Statement st;
					st = conexion.createStatement();
