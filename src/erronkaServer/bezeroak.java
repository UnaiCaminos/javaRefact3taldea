...
public class bezeroak extends JFrame {
	...
	public bezeroak() {
		...
		table = new JTable();
		table.setBounds(157, 13, 904, 509);
		...
		btnGehitu.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
				    konexioaServer kon=new konexioaServer();
				    Connection conexion = kon.getConnection();
				    String izn,abz1,abz2,nan,bankuNum,helbidea,tel;
				    ...
				    String query ="INSERT INTO erronka2.bezeroak"
						+ " Values('"+izn+"', '"+abz1+"', '"+abz2+"', '"+nan+"', '"+bankuNum+"', '"+helbidea+"', '"+tel+"')";
				    Statement stmt;
		...
		btnKendu.setBounds(10, 203, 101, 21);
		...
		btnAktualizatu.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
				    ...
				    String query ="UPDATE bezeroak SET "+mod1+" ='"+mod2+"', "+mod3+" ='"+mod4+"' WHERE izena= '"+izn+"'&& abizena1='"+abz+"'";
				    Statement st;
					st = conexion.createStatement();
					st .executeUpdate(query);
		...
		btnAktualizatu.setBounds(10, 274, 101, 21);
		...
		btnBilatu.setBounds(10, 434, 101, 21);
